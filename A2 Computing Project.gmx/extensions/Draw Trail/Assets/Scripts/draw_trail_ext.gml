///draw_trail(Width,Color,Sprite,Slim,Alpha)
//Ex. draw_trail(32,c_white,-1,1,1)
var Width,Color,Sprite,Slim,Alpha,AlphaT,Texture,Dir,Lenght;
//Preparing variables
...
for(var i = 0; i < Lenght; i++){
  ...
  draw_vertex_texture_colour(GridTrail[# i,0] + XX,GridTrail[# i,1] + YY,GridTrail[# i,2] / Width,0,Color,AlphaT);
  draw_vertex_texture_colour(GridTrail[# i,0] - XX,GridTrail[# i,1] - YY,GridTrail[# i,2] / Width,1,Color,AlphaT);
}
draw_primitive_end();